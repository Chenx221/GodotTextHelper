...
#pragma comment(linker, "/export:CloseDriver=C:\\Windows\\System32\\C:\\Windows\\System32\\winmm.CloseDriver")
#pragma comment(linker, "/export:DefDriverProc=C:\\Windows\\System32\\C:\\Windows\\System32\\winmm.DefDriverProc")
#pragma comment(linker, "/export:DriverCallback=C:\\Windows\\System32\\C:\\Windows\\System32\\winmm.DriverCallback")
#pragma comment(linker, "/export:GetDriverModuleHandle=C:\\Windows\\System32\\C:\\Windows\\System32\\winmm.GetDriverModuleHandle")
...
bool Initialize() {
    OutputDebugStringA("[Proxy] Initializing hooks\n");
    return SetupAllHooks();
}

void Cleanup() {
    CleanupAllHooks();
    OutputDebugStringA("[Proxy] Cleanup complete\n");
}
